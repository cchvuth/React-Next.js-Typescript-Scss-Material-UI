...
const ActiveLink: React.FC<LinkProps> = (props) => {
  ...
  if (typeof props.href === 'object') {
    throw new TypeError('[ActiveLink] href props as an object is deprecated since Next.js 9');
  }
  if (typeof props.as === 'object') {
    throw new TypeError('[ActiveLink] as props as an object is deprecated since Next.js 9');
  }
